...
class SpatialNLPEngine:
    ...
    def analyze_point_location(
        ...
        return {
            ...
            "ndvi": spectral_readout.get("ndvi_vegetation_proxy"),
            "ndwi": spectral_readout.get("ndwi_water_proxy"),
            "ndbi": spectral_readout.get("ndbi_builtup_proxy"),
            "sar_backscatter_db": spectral_readout.get("radar_roughness_db_proxy"),
